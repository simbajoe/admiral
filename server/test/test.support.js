...
exports.testSupportGreen06 = function(test) {
    ...
    Util.checkWorld(test, world, map_expected, world.players[0].id, Config.SUPPORT_PHASE);
    Util.supportAndCheck(test, world, world.players[0].id, {skip: true});
...
exports.testSupportGreen07 = function(test) {
    ...
    Util.setupWorld(test, world, map, world.players[1].id, Config.ATTACK_PHASE);
    Util.attackAndCheck(test, world, world.players[1].id, {from: [8, 5], to: [8, 6]});
...
exports.testSupportGreen08 = function(test) {
    ...
    Util.checkWorld(test, world, map_expected, world.players[0].id, Config.SUPPORT_PHASE);
    Util.supportAndCheck(test, world, world.players[0].id, [9, 7]);
...
exports.testSupportGreen09 = function(test) {
...
exports.testSupportGreen10 = function(test) {
    ...
    Util.setupWorld(test, world, map, world.players[1].id, Config.ATTACK_PHASE);
    Util.attackAndCheck(test, world, world.players[1].id, {from: [8, 8], to: [8, 7]});
    ...
    Util.checkWorld(test, world, map_expected, world.players[0].id, Config.SUPPORT_PHASE);
    Util.supportAndCheck(test, world, world.players[0].id, [8, 6]);
    ...
    Util.checkWorld(test, world, map_expected, world.players[0].id, Config.SUPPORT_PHASE);
    Util.supportAndCheck(test, world, world.players[0].id, [9, 6]);
