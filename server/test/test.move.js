...
exports.testMoveTorpedo05 = function(test) {
    ...
    Util.setupWorld(test, world, map, world.players[0].id, Config.MOVE_PHASE);
    Util.testWhereCanMove(test, world, [8, 6], []);
...
exports.testMoveMine04 = function(test) {
    ...
    Util.setupWorld(test, world, map, world.players[0].id, Config.MOVE_PHASE);
    Util.testWhereCanMove(test, world, [8, 5], []);
...
exports.testMoveAirplane03 = function(test) {
